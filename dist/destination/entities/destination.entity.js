...
__decorate([
    (0, graphql_1.Field)(() => [holiday_entity_1.Package], { nullable: true }),
    (0, typeorm_1.ManyToMany)(() => holiday_entity_1.Package, (question) => question.destinations),
    __metadata("design:type", Array)
], Destination.prototype, "holidays", void 0);
